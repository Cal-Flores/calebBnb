        ...
        <div className="statscont">
            <div className="spotdiv">
                ...
                {spotsArr.map(spot => (
                    <div className="spotwrap">
                        ...
                        <img className="profileimage" onClick={(e) => history.push(`/spots/${spot.id}`)} src={spot?.image} onError={(e) => { e.target.src = 'https://i0.wp.com/www.careandshare-ut.org/wp-content/uploads/2020/09/image-coming-soon.jpg?fit=1200%2C1200&ssl=1' }}></img>
                        <div>{spot?.name}</div>
            ...
            <div className="spotdiv">
                ...
                {bookingsArr.map(book => (
                    <div className="spotwrap">
                        <img className="profileimage" onClick={(e) => history.push(`/spots/${book.spotId}`)} src={book?.Spot?.image} onError={(e) => { e.target.src = 'https://i0.wp.com/www.careandshare-ut.org/wp-content/uploads/2020/09/image-coming-soon.jpg?fit=1200%2C1200&ssl=1' }}></img>
